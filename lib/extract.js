...
var remove_links = require('./remove_links_regex');
var tiles = {};
var csvString, rows;
/**
...
rows.forEach(function (row) {
  ...
  text[ row[1] ] = remove_links(text[ row[1] ]); // remove links from text
  // https://github.com/numo-labs/taggable-destination-data-extractor/issues/4
});
...
console.log('Tiles Saved to:', './tiles/all_destination_tiles.json');
/**
